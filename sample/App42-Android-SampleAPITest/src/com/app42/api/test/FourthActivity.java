...
AsyncApp42ServiceApi.App42ScoreBoardServiceListener {
	...
	private String gameName = "Android_Game";
	ListView list;
	...
	public void onGetScoreClicked(View viewe){
		...
		asyncService.getLeaderBoard(gameName, 6, this);
	}
	public void onSaveScoreClicked(View viewe){
		progressDialog = ProgressDialog.show(this, "", "Saving Score..");
		progressDialog.setCancelable(true);
		asyncService.saveScoreForUser(gameName, "Sachin", new BigDecimal(100), this);
	}
	@Override
	...
	public void onLeaderBoardSuccess(Game response) {
		...
		LazyAdapter adapter = new LazyAdapter(FourthActivity.this, nameList, rankList, scoreList);
